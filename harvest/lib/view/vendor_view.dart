...
class VendorViewPage extends StatefulWidget {
  ...
  const VendorViewPage({super.key, required this.vendorId});
...
class _VendorViewPageState extends State<VendorViewPage>
  ...
  Future<void> _filterVendorProducts(String categoryId) async {
    final vendorProducts = await _vendorProduct.getProductsByVendorAndCategory(
        widget.vendorId, categoryId);
    setState(() {
