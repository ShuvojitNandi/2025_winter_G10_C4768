...
import '../model/messaging_model.dart';
...
class ChatService {
  ...
  Future<void> sendMessage(DocumentSnapshot peer, String message) async {
    ...
    // notification
    String? device = await _deviceManager.getDeviceTokenFromUser(peer.id);
    if (device != null) {
      DeviceMessageRequest request = DeviceMessageRequest(device,
          title: "Message Received", body: message);

      await sendMessageToDevice(request);
    }
